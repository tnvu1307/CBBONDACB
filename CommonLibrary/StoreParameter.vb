...
#Region " Khai báo h?ng, bi?n "
    ...
    Private mv_strParamDirection As String
#End Region
...
#Region " Constructors and deconstructors "
    Public Sub New()
        ...
        mv_strParamDirection = String.Empty
    End Sub
#End Region

#Region " Các thu?c tính "
    ...
    Public Property ParamDirection() As String
        Get
            Return mv_strParamDirection
        End Get
        Set(ByVal Value As String)
            mv_strParamDirection = Value
        End Set
    End Property
#End Region
