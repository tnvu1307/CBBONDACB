...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents CbAPIVmoney As AppCore.ComboBoxEx
    Friend WithEvents lblSECRET As System.Windows.Forms.Label
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCALLAPIVMONEY))
        Me.btnOK = New System.Windows.Forms.Button()
        Me.btnCancel = New System.Windows.Forms.Button()
        Me.Panel1 = New System.Windows.Forms.Panel()
        Me.lblCaption = New System.Windows.Forms.Label()
        Me.lblSECRET = New System.Windows.Forms.Label()
        Me.CbAPIVmoney = New AppCore.ComboBoxEx()
        ...
        'CbAPIVmoney
        '
        Me.CbAPIVmoney.DisplayMember = "DISPLAY"
        Me.CbAPIVmoney.FormattingEnabled = True
        Me.CbAPIVmoney.Location = New System.Drawing.Point(145, 75)
        Me.CbAPIVmoney.Name = "CbAPIVmoney"
        Me.CbAPIVmoney.Size = New System.Drawing.Size(447, 21)
        Me.CbAPIVmoney.TabIndex = 20
        Me.CbAPIVmoney.ValueMember = "VALUE"
        '
        'frmCALLAPIVMONEY
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 14)
        Me.ClientSize = New System.Drawing.Size(608, 181)
        Me.Controls.Add(Me.CbAPIVmoney)
        ...
        Me.Name = "frmCALLAPIVMONEY"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent
        Me.Tag = "CHANGESECRET"
        Me.Text = "frmCALLAPIVMONEY"
...
#Region " Overridable methods"
    ...
    Public Overridable Sub OnInit()
        Try
            ...
            mv_ResourceManager = New Resources.ResourceManager(gc_RootNamespace & ".frmCALLAPIVMONEY-" & UserLanguage, System.Reflection.Assembly.GetExecutingAssembly())
    ...
    Public Overridable Sub LoadUserInterface(ByRef pv_ctrl As Windows.Forms.Control)
        ...
        Try
            ...
            v_strSQL = "SELECT CDVAL VALUE, CDCONTENT DISPLAY, EN_CDCONTENT EN_DISPLAY, LSTODR FROM ALLCODE WHERE CDTYPE = 'SA' AND CDNAME = 'VMONEYAPI' ORDER BY LSTODR"
            v_strObjMsg = BuildXMLObjMsg(, BranchId, , TellerId, gc_IsLocalMsg, gc_MsgTypeObj, OBJNAME_SA_LOOKUP, gc_ActionInquiry, v_strSQL)
            v_ws.Message(v_strObjMsg)
            FillComboEx(v_strObjMsg, CbAPIVmoney, "", Me.UserLanguage)
            'Load caption của form, label caption
            Me.Text = mv_ResourceManager.GetString("frmCALLAPIVMONEY")
            lblCaption.Text = mv_ResourceManager.GetString("lblCaption") & GroupName

            'lblCaption.Text = mv_ResourceManager.GetString("frmCALLAPIVMONEY.lblCaption") & GroupName
    ...
    '                End If
    '                'Display caption
    '                lblCaption.Text = mv_ResourceManager.GetString("frmCALLAPIVMONEY_USR.lblCaption") & v_strGroupName
    '            Else
    '                v_strGroupId = CStr(cboGROUP.SelectedValue).Trim
    '                v_strGroupName = cboGROUP.Text
    '                v_strHashKey = cboBRANCH.SelectedValue & "|" & cboGRPTYPE.SelectedValue & "|" & cboGROUP.SelectedValue
    ...
    '                End If
    '                'Display caption
    '                lblCaption.Text = mv_ResourceManager.GetString("frmCALLAPIVMONEY.lblCaption") & v_strGroupName
    '            End If
    '        End If
    '    Catch ex As Exception
    '        Throw ex
    ...
    Public Overridable Sub OnSave()
        ...
        Try
            v_strClause = CbAPIVmoney.SelectedValue
            'Build XML message
            v_strObjMsg = BuildXMLObjMsg(, BranchId, , TellerId, gc_IsNotLocalMsg, gc_MsgTypeObj, "SA.CHANGESECRET", gc_ActionAdhoc, , v_strClause, "CallAPIVmoney", gc_AutoIdUsed, )
...
#Region " Form events "
    ...
    Private Sub frmCALLAPIVMONEY_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
        Try
    ...
    Private Sub frmCALLAPIVMONEY_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        OnInit()
    End Sub
