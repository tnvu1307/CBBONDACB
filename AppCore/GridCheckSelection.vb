...
''' </summary>
Public Class GridCheckSelection
    ...
    Public mv_strColumName As String = String.Empty
    Public mv_strCaption As String = String.Empty
    Public mv_intColumWidth As Integer = 10
    ...
    Public Sub New(ByVal view As GridView, Optional ByVal pv_ColumName As String = "", Optional ByVal pv_ColumCaption As String = "", Optional ByVal pv_ColumWidth As Integer = 10)
        Me.New()
        mv_strColumName = pv_ColumName
        mv_strCaption = pv_ColumCaption
        mv_intColumWidth = pv_ColumWidth
    ...
    Protected Overridable Sub Attach(ByVal view As GridView)
        Try
            ...
            If Not view.Columns.Contains(view.Columns.ColumnByFieldName(mv_strColumName)) Then
                ...
                Me._column.FieldName = mv_strColumName
                Me._column.Caption = mv_strCaption
                Me._column.OptionsColumn.ShowCaption = True
                Me._column.UnboundType = DevExpress.Data.UnboundColumnType.Boolean
                Me._column.ColumnEdit = Me._edit
                Me._column.Width = mv_intColumWidth
            End If
        ...
        Try
            If ((e.Clicks = 1) _
                ...
                If Not Me.gridView.OptionsSelection.MultiSelect Then
                    ...
                    If (info.InRow _
                               AndAlso (info.Column Is Me._column)) Then
                        Me.SelectRow(info.RowHandle, Me.IsRowSelected(info.RowHandle))
                    End If
